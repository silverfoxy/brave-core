...
hooks = [
  ...
  },
  {
    ...
    'pattern': '.',
    'condition': 'checkout_android',
    'action': ['python3', 'script/download_rust_deps.py', '--platform', 'android'],
  },
  {
  ...
  },
  {
    ...
    'pattern': '.',
    'action': ['python', 'script/build-simple-js-bundle.py', '--repo_dir_path', 'src/brave/components/brave_sync/extension/brave-sync'],
    'condition': 'not checkout_android',
  },
  {
    ...
    'name': 'build_brave_sync',
    'pattern': '.',
    'action': ['python', 'script/build-simple-js-bundle.py', '--repo_dir_path', 'src/brave/components/brave_sync/extension/brave-sync-android'],
    'condition': 'checkout_android',
  },
  {
