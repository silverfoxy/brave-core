...
void FeedController::DoesFeedVersionMatch(
    std::string matching_hash,
...
void FeedController::EnsureFeedIsUpdating() {
  ...
  auto onRequest = base::BindOnce(
      [](FeedController* controller, const int status, const std::string& body,
            ...
            [](FeedController* controller, const std::string& body,
              ...
              auto onHistory = base::BindOnce(
                  [](FeedController* controller, const std::string& body,
                    ...
                    if (ParseFeed(body, history_hosts, &publishers,
