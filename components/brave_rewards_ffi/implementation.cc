#include <iostream>
#include <vector>
#include "br-rs/brave-rewards-cxx/src/wrapper.hpp"
...
namespace brave_rewards {
  ...
  {
  public:
      std::function<void(RewardsResult result, rust::cxxbridge1::Str order)> CbFunc = nullptr;
      void cb(RewardsResult result, rust::cxxbridge1::Str order) {
          if (CbFunc)
          {
              CbFunc(result, order);
          }
